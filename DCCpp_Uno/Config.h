...
/////////////////////////////////////////////////////////////////////////////////////
//
// DEFINE USE_KEYPAD ACCORDING TO THE FOLLOWING TABLE:
//
//  COMMENTED = Standar DCC++ command station.
//  DEFINED = Adafruit keypad (i2C 16x2 LCD + 5 Keys are available
...
//  2 = EXTERNAL L293 MOTOR BOARD     (MAX 18V/2.5??A PER CHANNEL)
