...
// If we use I2C for the keypad, the dump configuration on boot change to A3
#ifdef USE_KEYPAD
#define DUMP_CONFIG_PING A3
#else
#define DUMP_CONFIG_PING A5
#endif
...
#define MOTOR_SHIELD_NAME "EXTERNAL L298 Motor Board"
...
#define NOT_NEED_JUMPER_FOR_SHIELD
#else
